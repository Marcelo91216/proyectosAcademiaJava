...
public class ChickenBuilder implements Builder {
	...
	@Override
	public ChickenTacos getResult() {
		return new ChickenTacos(salsa, complement, tortilla);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ChickenBuilder other = (ChickenBuilder) obj;
